...
if __name__ == "__main__":
    ...
    while True:
        ...
        hour_end_x_coor = 450 + 140 * math.sin(math.pi * (hour / 6 + minute / 360))
        hour_end_y_coor = 300 - 140 * math.cos(math.pi * (hour / 6 + minute / 360))
        pygame.draw.line(screen, white, (450, 300), (hour_end_x_coor, hour_end_y_coor), 15)
