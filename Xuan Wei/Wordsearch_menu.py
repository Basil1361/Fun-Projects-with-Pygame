...
class Start(QWidget):
    def __init__(self):
        ...
        self.audio_combo.addItem("1-01-Liyue.mp3")
        self.audio_combo.addItem("1-02-Legend_of_the_Wind.mp3")
        self.audio_combo.addItem("1-05-Sun_Rises_in_Liyue.mp3")
        self.audio_combo.addItem("1-06-Good_Night_Liyue.mp3")
        self.audio_combo.addItem("1-08-Another_Day_in_Mondstadt.mp3")
        self.audio_combo.addItem("2-02-The_Fading_Stories_Qingce_Night.mp3")

        self.theme_lbl = QLabel("Theme:", self)
        self.theme_combo = QComboBox(self)
        self.theme_combo.addItem("Black (Default)")
        self.theme_combo.addItem("Mona's Starry Night.jpg")
